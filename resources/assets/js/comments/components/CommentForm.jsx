...
class CommentForm extends Component {
    ...
    postComment(event, text, url){
        ...
        jQuery.ajax({
            ...
            this.props.postComment(text, url, payload);
            ...
            <div>
                <form onSubmit={(event) => this.postComment(event, this.state.text, this.props.postCommentUrl)} className="comment-form" action={this.props.postCommentUrl} method="post">
                    <div className="form-group">
                        ...
                        <textarea ref="textarea" onChange={(event) => this.setState({text: event.target.value})} className="form-control" name="message_content" id="commentsField" rows="5"></textarea>
